...
Item {
    ...
    Rectangle {
        ...
        color: (root.open || mouse.containsMouse) && root.powered ? Qt.alpha(Theme.accent, 0.16) : "transparent"

        Text { anchors.centerIn: parent; text: "B"; color: root.powered ? Theme.accent : Theme.textMuted; font.pixelSize: 11; font.weight: Font.Bold }
